...
CREATE TABLE cohort_sections (
  ...
  training_status ENUM('planned','in_progress','completed','cancelled','pending_reschedule') NOT NULL DEFAULT 'planned',
  status ENUM('active','inactive','archived') NOT NULL DEFAULT 'active',
  created_at DATETIME NOT NULL DEFAULT CURRENT_TIMESTAMP,
  updated_at DATETIME NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP,
...
CREATE TABLE marketing_stages (
  ...
  status ENUM('active','completed','pending','at_risk') NOT NULL DEFAULT 'active',
...
CREATE TABLE marketing_stage_history (
  ...
  old_status ENUM('active','completed','pending','at_risk') NULL,
  new_status ENUM('active','completed','pending','at_risk') NOT NULL,
  risk_notes TEXT NULL,
...
CREATE TABLE cohort_comments (
  ...
  category ENUM('general','risk','change_request') NOT NULL DEFAULT 'general',
  body TEXT NOT NULL,
  created_at DATETIME NOT NULL DEFAULT CURRENT_TIMESTAMP,
